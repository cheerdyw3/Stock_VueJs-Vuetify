    ...
    <v-content>
        ...
        <v-card width="1000" class="mx-auto mt-5 px-5 elevation-3">
            <v-container class="fill-height" fluid> 
                ...
                <v-row no-gutters class="mt-3" v-for="(item,i) in Committees" :key="i">
                    <formMemberB :count="++i" :id="item.id" @dataFormB="dataFormB($event)"  v-if="form.FormA"></formMemberB>
                </v-row>
        ...
        <v-card width="1000" class="mt-5 mx-auto px-5 elevation-3">
            <v-container class="fill-height" fluid> 
                ...
                <formMemberE :dataFormA="data.dataA" :dataFormD="data.dataC" @dataFormE="dataFormE($event)"  v-if="form.FormD"></formMemberE>
            </v-container>
        </v-card>
        ...
        <v-card width="1000" class="mt-5 mx-auto px-5 elevation-3">
            <v-container class="fill-height" fluid> 
                <v-row no-gutters>
                    <v-col cols="12" class="d-flex">
                        6.เอกสารประกอบหารสมัครเป็นตัวแทนจำหน่ายประเภท "นิติบุคคล"
                    </v-col>
                </v-row>
